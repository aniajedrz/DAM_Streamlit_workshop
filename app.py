...
# Tabs
# =========================================================
tab1, tab2 = st.tabs(["Overviw", "Cancelations"])
...
with tab1:
    ...
    c1, c2 = st.columns(2)
    with c1:
        st.markdown("#### Revenue by vahicle type")
    ...
    st.caption("Each point is one compleated ride")
    fig = px.scatter(
        completed_rides,
        x="Ride Distance",
        y="Booking Value",
...
with tab2:
    ...
    st.radio("issue_type",["All issues", "Costumer cancelation", "driver cancelation", "incomplete ride"], horizontal=True)
    ...
    # -------------
    with c2:
            if issue_type == "Costumer cancelation":
            st.markdown("#### Reason for cancelling by costumer")
    ...
    # -------------
        ...
        elif issue_type == "driver cancelation"
        st.markdown("### Driver cancelation reason")
    ...
    # -------------
        ...
        elif issue_type == "incomplete ride"
        st.markdown("#### Incomlete rides reason")
